...
public final class SDCardUtils {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager sm = (StorageManager) BaseApplication.Companion.getCONTEXT().getSystemService(Context.STORAGE_SERVICE);
    ...
    public static class SDCardInfo {
        ...
        public String toString() {
            return "SDCardInfo {" +
                    ...
                    ", totalSize = " + Formatter.formatFileSize(BaseApplication.Companion.getCONTEXT(), totalSize) +
                    ", availableSize = " + Formatter.formatFileSize(BaseApplication.Companion.getCONTEXT(), availableSize) +
                    '}';
        }
    }
}

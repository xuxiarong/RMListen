...
public final class StringUtils {
    ...
    public static String getString(@StringRes int id) {
        try {
            return BaseApplication.Companion.getCONTEXT().getResources().getString(id);
    ...
    public static String getString(@StringRes int id, Object... formatArgs) {
        try {
            return BaseApplication.Companion.getCONTEXT().getString(id, formatArgs);
        } catch (Resources.NotFoundException ignore) {
            return "";
        }
    }
    ...
    public static String[] getStringArray(@ArrayRes int id) {
        try {
            return BaseApplication.Companion.getCONTEXT().getResources().getStringArray(id);
        } catch (Resources.NotFoundException ignore) {
            return new String[0];
        }
    }

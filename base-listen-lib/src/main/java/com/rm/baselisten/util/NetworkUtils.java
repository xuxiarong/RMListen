...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        BaseApplication.Companion.getCONTEXT().startActivity(
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseApplication.Companion.getCONTEXT().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) BaseApplication.Companion.getCONTEXT().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager tm =
                (TelephonyManager) BaseApplication.Companion.getCONTEXT().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm == null) return "";
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) BaseApplication.Companion.getCONTEXT().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static String getSSID() {
        WifiManager wm = (WifiManager) BaseApplication.Companion.getCONTEXT().getApplicationContext().getSystemService(WIFI_SERVICE);
        if (wm == null) return "";
...
//                        BaseApplication.Companion.getCONTEXT().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
//                    }
//                }
//            });
//        }
...
//                BaseApplication.Companion.getCONTEXT().unregisterReceiver(NetworkChangedReceiver.getInstance());
//            }
//        }
//        @SuppressLint("MissingPermission")
//        @Override
...
//        ConnectivityManager cm = (ConnectivityManager) BaseApplication.Companion.getCONTEXT().getSystemService(Context.CONNECTIVITY_SERVICE);
//        if (cm == null) return;

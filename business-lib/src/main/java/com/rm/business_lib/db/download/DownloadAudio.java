...
public class DownloadAudio implements Serializable {
    ...
    @Generated(hash = 735513931)
    public DownloadAudio(Long audio_id, String audio_type, String audio_name,
            String original_name, String status, String author_intro, String anchor_id,
            String short_intro, String audio_intro, String audio_cover, String cover_url,
            String audio_label, String quality, String progress, String play_count,
            String created_at, String chapter_updated_at, String author, String member_id,
    ...
    public String getAudio_label() {
        return this.audio_label == null ? "" : this.audio_label;
    }

    public void setAudio_label(String audio_label) {
        this.audio_name = audio_label;
    }

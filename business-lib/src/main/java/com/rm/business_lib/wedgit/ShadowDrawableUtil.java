...
public class ShadowDrawableUtil extends Drawable {
    ...
    public static void setShadowDrawable(View view, int shape, TypeEnum type, int shapeColor, int shapeRadius, int shadowColor, int shadowRadius) {
        ShadowDrawableUtil drawable = new Builder()
                .setBgColor(shapeColor)
                .setShapeRadius(shapeRadius)
                .setShadowColor(shadowColor)
    ...
    private static class Builder {
        ...
        private Builder() {
            mShape = SHAPE_ROUND_PART;
            type = TypeEnum.All;
            mShapeRadius = 17;
            mShadowColor = Color.parseColor("#666666");
            mShadowRadius = 6;
            mBgColor = new int[1];

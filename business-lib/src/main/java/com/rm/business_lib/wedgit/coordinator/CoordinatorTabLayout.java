...
import static com.rm.baselisten.utilExt.DisplayUtilsKt.getStateHeight;
...
public class CoordinatorTabLayout extends CoordinatorLayout {
    ...
    public CoordinatorTabLayout setBackEnable(Boolean canBack) {
        if (canBack && mActionbar != null) {
            ...
            mActionbar.setHomeAsUpIndicator(R.drawable.base_icon_back);
        }
        return this;
    }
    ...
    public CoordinatorTabLayout setTranslucentStatusBar(@NonNull Activity activity) {
        ...
        if (mToolbar != null) {
            ...
            layoutParams.setMargins(
                    ...
                    layoutParams.topMargin + DisplayUtils.INSTANCE.getStateHeight(activity),
    ...
    public CoordinatorTabLayout setTranslucentNavigationBar(@NonNull Activity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            ...
            mToolbar.setPadding(0, DisplayUtils.INSTANCE.getStateHeight(activity) >> 1, 0, 0);
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {

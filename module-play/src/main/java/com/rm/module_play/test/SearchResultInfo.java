...
public class SearchResultInfo implements Parcelable {
    ...
    protected SearchResultInfo(Parcel in) {
        value320filesize = in.readInt();
        value320hash = in.readString();
        value320privilege = in.readInt();
        Accompany = in.readInt();
        album_audio_id = in.readInt();
        album_id = in.readString();
        album_name = in.readString();
        album_img = in.readString();
        audio_id = in.readLong();
        bitrate = in.readInt();
        duration = in.readInt();
        extname = in.readString();
        fail_process = in.readInt();
        fail_process_320 = in.readInt();
        fail_process_sq = in.readInt();
        feetype = in.readInt();
        filename = in.readString();
        filesize = in.readInt();
        fold_type = in.readInt();
        hash = in.readString();
        isnew = in.readInt();
        isoriginal = in.readInt();
        m4afilesize = in.readInt();
        mvhash = in.readString();
        old_cpy = in.readInt();
        othername = in.readString();
        othername_original = in.readString();
        ownercount = in.readInt();
        pay_type = in.readInt();
        pay_type_320 = in.readInt();
        pay_type_sq = in.readInt();
        pkg_price = in.readInt();
        pkg_price_320 = in.readInt();
        pkg_price_sq = in.readInt();
        price = in.readInt();
        price_320 = in.readInt();
        price_sq = in.readInt();
        privilege = in.readInt();
        rp_publish = in.readInt();
        rp_type = in.readString();
        singername = in.readString();
        songname = in.readString();
        songname_original = in.readString();
        source = in.readString();
        sourceid = in.readInt();
        sqfilesize = in.readInt();
        sqhash = in.readString();
        sqprivilege = in.readInt();
        srctype = in.readInt();
        topic = in.readString();
        topic_url = in.readString();
        id = in.readLong();
        group = in.createTypedArrayList(SearchResultInfo.CREATOR);
        selected = in.readByte() != 0;
    }

    public static final Creator<SearchResultInfo> CREATOR = new Creator<SearchResultInfo>() {
        @Override
        public SearchResultInfo createFromParcel(Parcel in) {
            return new SearchResultInfo(in);
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeInt(value320filesize);
        dest.writeString(value320hash);
        dest.writeInt(value320privilege);
        dest.writeInt(Accompany);
        ...
        dest.writeInt(fail_process);
        dest.writeInt(fail_process_320);
        dest.writeInt(fail_process_sq);
        dest.writeInt(feetype);
        dest.writeString(filename);
        dest.writeInt(filesize);
        dest.writeInt(fold_type);
        dest.writeString(hash);
        dest.writeInt(isnew);
        dest.writeInt(isoriginal);
        dest.writeInt(m4afilesize);
        dest.writeString(mvhash);
        dest.writeInt(old_cpy);
        dest.writeString(othername);
        dest.writeString(othername_original);
        dest.writeInt(ownercount);
        dest.writeInt(pay_type);
        dest.writeInt(pay_type_320);
        dest.writeInt(pay_type_sq);
        dest.writeInt(pkg_price);
        dest.writeInt(pkg_price_320);
        dest.writeInt(pkg_price_sq);
        dest.writeInt(price);
        dest.writeInt(price_320);
        dest.writeInt(price_sq);
        dest.writeInt(privilege);
        dest.writeInt(rp_publish);
        dest.writeString(rp_type);
        dest.writeString(singername);
        dest.writeString(songname);
        dest.writeString(songname_original);
        dest.writeString(source);
        dest.writeInt(sourceid);
        dest.writeInt(sqfilesize);
        dest.writeString(sqhash);
        dest.writeInt(sqprivilege);

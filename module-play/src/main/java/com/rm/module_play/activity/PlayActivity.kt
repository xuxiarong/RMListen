...
class PlayActivity : BaseNetActivity<com.rm.module_play.databinding.ActivityPlayBinding, PlayViewModel>() {
    override fun getLayoutId(): Int = R.layout.activity_play
    override fun initViewModel(): PlayViewModel = mViewModel

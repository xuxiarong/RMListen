...
@BindingAdapter(
    "bindShadowCountryCode",
    "bindShadowPhoneEnable",
    "bindShadowPasswordEnable",
    requireAll = false
)
fun View.bindLoginBtnShadowVisible(countryCode: String?, phone: String?, password: String?) {
    val visible = if (phone == null && password == null) {
        // 都为空
        false
    } else if (phone != null && password == null) {
        // 只是验证电话是否ok

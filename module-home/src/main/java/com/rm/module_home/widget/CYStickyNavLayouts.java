...
public class CYStickyNavLayouts extends LinearLayout implements NestedScrollingParent {
    ...
    private HomeAudioHorDoubleRvModel blockModel;
    // 解决多点触控问题
    ...
    public void bindBlockModel(HomeAudioHorDoubleRvModel blockModel) {
    ...
    public void onStopNestedScroll(View target) {
        ...
        if (getScrollX() > maxWidth + maxWidth * 9 / 10 ) {
//            mlistener.onStart();
            if(blockModel!=null){
                HomeTopicListActivity.Companion.startTopicActivity(
                        getContext(),
                        blockModel.getBlock().getTopic_id(),
                        blockModel.getBlock().getBlock_name()
                );
            }
        }
    }

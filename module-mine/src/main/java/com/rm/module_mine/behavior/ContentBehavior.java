...
public class ContentBehavior extends CoordinatorLayout.Behavior<View> {
     ...
     * fling是否从折叠状态发生的
     */
    private boolean flingFromCollaps = false;
    ...
    public ContentBehavior(Context context, AttributeSet attrs) {
        ...
        contentTransY = (int) context.getResources().getDimension(R.dimen.dp_325);
        downEndY = (int) context.getResources().getDimension(R.dimen.dp_289);

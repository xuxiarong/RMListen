...
internal object TagUtil {
    ...
    private const val KEY_HOLDER = 5
    ...
    fun saveHolder(task: DownloadTask, holder: Any) {
        task.addTag(KEY_HOLDER, holder)
    }

    fun getHolder(task: DownloadTask): Any? {
        return task.getTag(KEY_HOLDER)
    }
